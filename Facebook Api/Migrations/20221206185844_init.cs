        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplyCommentIdId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Comments_Comments_ReplyCommentIdId",
                        column: x => x.ReplyCommentIdId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_ReplyCommentIdId",
                table: "Comments",
                column: "ReplyCommentIdId");
